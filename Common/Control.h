...
public:
	...
	void drawIt(Graphics& g, Control* control, bool doubleborder);
	virtual void add(Control* newControl);
	virtual void draw(Graphics& g,bool doubleborder);
	...
	virtual void setDoubleBorder(bool Dborder) { this->doubleborder = Dborder; };
	...
	virtual bool isDoubleBorder(){ return doubleborder; };

	virtual void drawBorder(Graphics& g, Control* control, bool doubleborder);

	virtual void setColor(Color background, Color foreground);
	void setConnectedControl(Control* c);
	virtual void drawInside(Graphics& g, bool doubleborder) = 0;
	~Control();
};
